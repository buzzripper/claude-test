...
public static class DataSeeder
{
    ...
    private static async Task SeedApplicationsAndPermissionsAsync(IServiceProvider serviceProvider)
    {
        ...
        // Create Permissions for Auth App
        var authPermissions = new[]
        {
            ...
            { 
                ...
                ApplicationId = authApp.Id, 
                Name = "users.manage", 
                DisplayName = "Manage Users (assign roles/permissions)" 
            }
        };

        // Create Permissions for App1
        ...
        var notifPermissions = new[]
        {
            ...
            { 
                Id = Guid.NewGuid(), 
                ApplicationId = notificationsApp.Id, 
        ...
        // Create Roles for App1
        var app1AdminRole = new ApplicationRole
        {
            Id = Guid.NewGuid(),
            ApplicationId = app1.Id,
            Name = "Admin",
            Description = "App1 Administrator"
        };

        var app1ManagerRole = new ApplicationRole
        {
            Id = Guid.NewGuid(),
            ApplicationId = app1.Id,
            Name = "Manager",
            Description = "App1 Manager"
        };

        var app1UserRole = new ApplicationRole
        {
            Id = Guid.NewGuid(),
            ApplicationId = app1.Id,
            Name = "User",
            Description = "App1 Regular User"
        };

        context.ApplicationRoles.AddRange(app1AdminRole, app1ManagerRole, app1UserRole);
        await context.SaveChangesAsync();

        // Map permissions to roles for App1
        var app1AdminRolePerms = app1Permissions.Select(p => new RolePermission
        {
            Id = Guid.NewGuid(),
            RoleId = app1AdminRole.Id,
            PermissionId = p.Id
        });

        var app1ManagerRolePerms = app1Permissions
            .Where(p => p.Name != "products.delete")
            .Select(p => new RolePermission
            {
                Id = Guid.NewGuid(),
                RoleId = app1ManagerRole.Id,
                PermissionId = p.Id
            });

        var app1UserRolePerms = app1Permissions
            .Where(p => p.Name == "products.read")
            .Select(p => new RolePermission
            {
                Id = Guid.NewGuid(),
                RoleId = app1UserRole.Id,
                PermissionId = p.Id
            });
    ...
    private static async Task SeedUsersAsync(IServiceProvider serviceProvider)
    {
        ...
        var acmeOrg = await context.Organizations
            .FirstAsync(o => o.Slug == "acme-corp");
        var app1 = await context.Applications
            .FirstAsync(a => a.ClientId == "app1-api");
        var app1AdminRole = await context.ApplicationRoles
            .FirstAsync(r => r.ApplicationId == app1.Id && r.Name == "Admin");
        var app1ManagerRole = await context.ApplicationRoles
            .FirstAsync(r => r.ApplicationId == app1.Id && r.Name == "Manager");
        var app1UserRole = await context.ApplicationRoles
            .FirstAsync(r => r.ApplicationId == app1.Id && r.Name == "User");
